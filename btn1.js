...
if(btn1) btn1.addEventListener("click", function () {
  window.open(
    "https://www.youtube.com/watch?v=v8Gym_Fp4yo&list=PLX2nboN_I954eo5_I_pEPtFxeGWR9fKMl"
  );
});

if(btn2) btn2.addEventListener("click", function () {
  window.open("https://www.twitch.tv/syllabearretrocycles");
});

if(btn3) btn3.addEventListener("click", function () {
  window.open("https://discord.gg/dcpaauj");
});

if(btn4) btn4.addEventListener("click", function () {
  window.open("http://resource.armagetronad.net/resource/");
});

if(btn5) btn5.addEventListener("click", function () {
  window.open(
    "http://wiki.armagetronad.org/index.php?title=Ladle/Challenge_Board"
  );
});
...
if(btn9) btn9.addEventListener("click", function () {
  window.open("https://retrocycles.net/");
});

if(btn10) btn10.addEventListener("click", function () {
  window.open("http://wiki.armagetronad.org/index.php?title=Main_Page");
});

if(btn11) btn11.addEventListener("click", function () {
  window.open("https://forums3.armagetronad.net/");
});

if(btn12) btn12.addEventListener("click", function () {
